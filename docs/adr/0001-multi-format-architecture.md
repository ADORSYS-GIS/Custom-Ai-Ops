...
3. **Exposure Plane** — uniform OpenAI-compatible API
...
- Changing engines for a format only requires changing the Decision Tree in `engine-selector`, not the client.
